...
describe('Workout Template API CRUD operations', () => {
  ...
  let workoutBlockId1: string;
  let workoutBlockId2: string;
  ...
  it('should get a workout template by ID', async () => {
    const response = await request(app).get(`/api/workout-templates/${workoutTemplateId}`);
    expect(response.status).toBe(200);
  ...
  it('should update a workout template by ID', async () => {
    const response = await request(app).put(`/api/workout-templates/${workoutTemplateId}`).send({
  ...
  it('should delete a workout template by ID', async () => {
    const response = await request(app).delete(`/api/workout-templates/${workoutTemplateId}`);
